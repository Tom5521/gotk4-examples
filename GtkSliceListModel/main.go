...
func activate(app *gtk.Application) {
	...
	// The main difference of GtkSliceListModel is that you always have to specify its length;
	// it's ideal for lists that won't be modified during the app's runtime.
	model := gtk.NewSliceListModel(strlist, 0, uint(len(items)))
